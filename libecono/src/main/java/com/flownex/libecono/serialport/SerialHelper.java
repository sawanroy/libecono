package com.flownex.libecono.serialport;
...
import com.flownex.libecono.serialport.bean.ComBean;
import com.flownex.libecono.serialport.stick.AbsStickPackageHelper;
import com.flownex.libecono.serialport.stick.BaseStickPackageHelper;
...
public abstract class SerialHelper {
    ...
    private String sPort = "/dev/ttymxc1";
    ...
    public SerialHelper(String sPort, int iBaudRate, int stopBits, int dataBits, int parity, int flowCon, int flags) {
        this.sPort = sPort;
